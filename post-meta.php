...
add_action( 'add_meta_boxes', 'veuse_priceitem_meta_box_add' );

function veuse_priceitem_meta_box_add()
{
	add_meta_box( 'veuse_priceitem_meta', __('Price Items','veuse-priceitem'), 'veuse_priceitem_meta_box_cb', 'priceitem', 'normal', 'high' );
	
}

function veuse_priceitem_meta_box_cb( $post )
{
...
add_action( 'save_post', 'veuse_priceitem_meta_box_save',2 );


function veuse_priceitem_meta_box_save( $post_id ){
